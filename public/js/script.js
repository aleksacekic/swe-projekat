$(window).on("load", function() {
    ...
    $(".zzatvaranje > ul > li > a").on("click", function(){
      ...
      $(document).ready(function() {
        var originalColor = $("#radio1").parent().css("background-color"); // ovde cuva prvu boju   
        $("input[name='exampleRadios']").click(function() {
          var clickedId = $(this).attr("id"); //ovde cuvamo id kliknutog dugmeta
          if (clickedId === "radio1" && !$("#radio1").parent().hasClass("changed-color")){//proverava jel boja nepromenjena zaRadio1
            $("#radio1").parent().css("background-color", "rgba(255, 215, 0)").addClass("changed-color");//menjaBoju&dodaKlasuCh-Col
            $("#radio2").parent().css("background-color", "").removeClass("changed-color");
          }else if (clickedId === "radio2" && !$("#radio2").parent().hasClass("changed-color")){//ProvJel boja nepromenjenaZaRadio2
            $("#radio2").parent().css("background-color", "rgba(255, 215, 0)").addClass("changed-color");//menjaBoju&dodaKlasuCh-Col
            $("#radio1").parent().css("background-color", "").removeClass("changed-color");
          } else {
            $("#radio1").parent().css("background-color", originalColor).removeClass("changed-color");//Vraca bg-color na prvobitnu
            $("#radio2").parent().css("background-color", originalColor).removeClass("changed-color");
          }
        });
      });
